...
const navigate = useNavigate();
  ...
  return (
    <div>
        <Button onPress={onOpen} className="text-base border-2 font-semibold text-white border-primaryhijau bg-primaryhijau">
                  Daftar
                </Button>
              ...
              <ModalBody>
                <div className="w-full flex flex-col justify-center items-center ">
                  ...
                  <div>
                    ...
                    id="nama" className="w-[20rem] rounded-xl mt-1 border-2 border-[#D0D0D0] pl-4 py-1 " placeholder="Masukkan Nama"  type="text" />
                  </div>
                  <div>
                    <p>Email</p>
                    <input onChange={(e) => setemail(e.target.value)}
                    id="email" className="w-[20rem] rounded-xl mt-1 border-2 border-[#D0D0D0] pl-4 py-1 " placeholder="Masukkan Email"  type="email" />
                  </div>
                  ...
                  <Button onClick={() => {
                          registerUser();
                        }}  className="px-[7rem] bg-[#315818] text-white font-semibold ">Daftar</Button>
                </div>
              </ModalBody>
              <ModalFooter>
