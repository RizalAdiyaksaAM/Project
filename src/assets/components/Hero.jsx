          ...
          <div className="flex justify-center items-center rounded-[3rem]  w-full bg-primaryhijau  ">
            <div className=" space-y-4 mx-4 ">
              ...
              <p className="text-base font-semibold w-[40.9375rem] ">
                Pesan sayur keliling secara online untuk pengalaman belanja yang lebih praktis dan efisien. Tidak perlu menunggu kedatangan tukang sayur, Anda dapat memilih dari beragam produk, melakukan transaksi dengan cepat, dan
                menikmati pengiriman langsung ke rumah.
              </p>
