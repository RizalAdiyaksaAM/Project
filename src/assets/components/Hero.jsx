          ...
          <div className="flex justify-center items-center rounded-[3rem]  w-full bg-primaryhijau  ">
            <div className=" space-y-4 mx-4 ">
              ...
              <p className="text-base font-semibold w-[40.9375rem] ">
                ...
                lebih praktis dan efisien. Tidak perlu menunggu kedatangan
                tukang sayur, Anda dapat memilih dari beragam produk, melakukan
                transaksi dengan cepat, dan menikmati pengiriman langsung ke
                rumah.
              </p>
              <Button className="bg-[#315818] text-white font-semibold text-base ">
                Pesan Sekarang
              </Button>
            </div>
            ...
            <div className="h-full flex justify-around items-center">
              <div className=" flex justify-center items-center gap-2">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm w-[14.03963rem]">
                    Pesan dan ambil sayuranmu dengan mudah
                  </p>
                </div>
              </div>
              <div className=" flex justify-center items-center gap-2">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm w-[14.03963rem]">
                    Dapatkan sensasi sayur yang segar dan kualitas terbaik
                  </p>
                </div>
              </div>
              <div className=" flex justify-center items-center gap-2">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm w-[14.03963rem]">
                    Transaksi menyenangkan dengan penjual yang interaktif
                  </p>
                </div>
              </div>
            </div>
